...
وجاوب بصيغة مختصرة جداً بالعربي، بدون شرح تقني أو أرقام كثيرة، بنفس الشكل التالي بالضبط
(بدون أي نص إضافي قبله أو بعده):
...
مهم جداً: التزم فقط بالتنسيق المطلوب أعلاه بثلاثة أسطر، بدون تحليل فني مطول، بدون ذكر أرقام
المؤشرات الخام، وبدون مقدمات أو خواتيم أو تحذيرات إضافية."""
    return prompt
